 ...
 */
class Tgmsp_Lite_Skin extends WP_Upgrader_Skin {
	...
	function error( $errors ) {
		...
		if ( ! empty( $errors ) )
			echo json_encode( array( 'error' => __( 'There was an error with your credentials. Please try entering them again.', 'soliloquy-lite' ) ) );
