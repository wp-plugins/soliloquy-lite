...
class Tgmsp_Lite_Strings {
	...
	public function __construct() {
		...
		$this->strings = apply_filters( 'tgmsp_strings', array(
			...
			'advanced_help_desc'	=> __( 'Want even more advanced features for Soliloquy? How about embedded video support for YouTube and Vimeo, easy internal linking, full support for available FlexSlider options and APIs, custom sizes, and even Addons?', 'soliloquy-lite' ),
			...
			'slider_cb'				=> __( 'For even more advanced functionality like embedded video support, controlling mousewheel and keyboard navigation, pause/play elements, extra animations, custom slider sizes registered with WordPress and smooth height controls, %s', 'soliloquy-lite' ),
